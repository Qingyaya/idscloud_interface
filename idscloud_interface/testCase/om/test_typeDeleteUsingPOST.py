...
class test_typeDeleteUsingPOST(unittest.TestCase):
    ...
    def setUp(self):
        ...
        cursor = db.cursor()
        cursor.execute("SELECT type_id FROM ids_type WHERE type_code = 'apitest' ")
        self.params['type_ids']=(cursor.fetchone())[0]

    def test_typeDeleteUsingPOST(self):
        u"""op_删除数据字典类型"""
