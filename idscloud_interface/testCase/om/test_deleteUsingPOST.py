...
class test_deleteUsingPOST(unittest.TestCase):
    ...
    def setUp(self):
        ...
        cursor = db.cursor()
        cursor.execute("SELECT company_id FROM ids_consume_company WHERE name = 'apitestop1' ")
        self.params['companyIds']=(cursor.fetchone())[0]
        db.close()

    def test_deleteUsingPOST(self):
        u"""op_删除企业"""
