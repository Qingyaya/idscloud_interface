...
class test_deleteSysPowerUsingPOST(unittest.TestCase):
    ...
    def setUp(self):
        ...
        cursor = db.cursor()
        cursor.execute("SELECT power_id FROM tb_power WHERE power_name = 'apitest' ")
        self.params['powerid']=(cursor.fetchone())[0]
        db.close()

    def test_deleteSysPowerUsingPOST(self):
        u"""op_删除菜单权限"""
