...
class test_userMessageUsingPOST(unittest.TestCase):
    ...
    def setUp(self):
        ...
        cursor = db.cursor()
        cursor.execute("SELECT usr_id FROM tb_user WHERE login_name = 'apitest03' ")
        self.params['uid']=(cursor.fetchone())[0]
        db.close()

    def test_userMessageUsingPOST(self):
        u"""eps_查询用户"""
