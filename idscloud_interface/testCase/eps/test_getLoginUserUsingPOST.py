...
class test_getLoginUserUsingPOST(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.rc=ReadConfig()
        self.params['token']=self.rc.get_headers('market')

    def test_getLoginUserUsingPOST(self):
        u"""eps_根据token得到登录用户信息"""
