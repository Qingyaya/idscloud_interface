...
class Log():
    ...
    def get_screenshot_path(self,keyname):
        screenshot_path=os.path.join(filepath, "screenshot")
        if not os.path.exists(screenshot_path):
            os.mkdir(screenshot_path)
        screenshot_path=os.path.join(screenshot_path,str(datetime.now().strftime("%Y%m%d")))
        if not os.path.exists(screenshot_path):
            os.mkdir(screenshot_path)
        screenshot_path=os.path.join(screenshot_path,str(datetime.now().strftime("%Y%m%d%H%M%S")) + '_' + keyname)
        if not os.path.exists(screenshot_path):
            os.mkdir(screenshot_path)
