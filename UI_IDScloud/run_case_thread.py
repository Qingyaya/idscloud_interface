...
from testCase.allscene_case.test_01_register import Register
from testCase.allscene_case.test_02_companyenter import Companyenter
Prodir =BASE_DIR
log=Log()
...
def runcase():
    ...
    if discover.countTestCases() == 0:
        ...
        suite.addTest(Companyenter('test_companyenter'))
