...
class test_typeValueDeleteUsingPOST(unittest.TestCase):
    ...
    def setUp(self):
        ...
        cursor = db.cursor()
        cursor.execute("SELECT type_value_id FROM ids_type_value WHERE type_value_name = 'apitest' ")
        self.params['type_value_ids']=(cursor.fetchone())[0]
        db.close()


    def test_typeValueDeleteUsingPOST(self):
        u"""op_删除类型值类型"""
